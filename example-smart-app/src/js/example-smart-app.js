  ...
  window.extractData = function () {
    ...
    function onReady(smart) {
      ...
      if (smart.hasOwnProperty('patient')) {
        ...
        pt.done(function (data) {
          sessionStorage.setItem('patientDetails', JSON.stringify(data));
        });
        ...
        obv.done(function (data) {
          sessionStorage.setItem('observationDetails', JSON.stringify(data));
        });
        ...
        org.done(function (data) {
          sessionStorage.setItem('orgDetails', JSON.stringify(data));
        });
        ...
        docRef.done(function (data) {
          sessionStorage.setItem('DocumentReference', JSON.stringify(data));
        });
        //console.log("333");
